...
export default function ScheduledTasksList({ currentUser, users, departments, t = (key) => key, onTaskFeedback, onLogActivity }) {
  ...
  const handleEditScheduledTask = (scheduledTask) => {
    ...
    try {
      ...
      if (onLogActivity) {
        onLogActivity(
          ...
          currentUser.name,
          { 
            recurrenceType: updatedTask.recurrencePattern?.type,
  ...
  return (
    <div>
      {/* Collapsible Header */}
      <div 
        className="flex items-center justify-between p-3 bg-slate-50 rounded-lg border border-slate-200 cursor-pointer hover:bg-slate-100 transition-colors mb-3"
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-1">
            ...
            <span className="text-xs bg-slate-100 text-slate-600 px-2 py-1 rounded-full">
              {scheduledTasks.filter(t => !t.isActive).length} paused
            </span>
          </div>
        </div>
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-start justify-between">
            ...
            <div className="flex items-center gap-1 ml-4">
              <button
                onClick={(e) => {
                  e.stopPropagation();
                  handleEditScheduledTask(scheduledTask);
                }}
              ...
              <button
                onClick={(e) => {
                  e.stopPropagation();
                  handleToggleActive(scheduledTask);
                }}
              ...
              <button
                onClick={(e) => {
                  e.stopPropagation();
                  handleDeleteScheduledTask(scheduledTask);
                }}
